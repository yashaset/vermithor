...
export default function Hero() {
  ...
  return (
    <section className="min-h-screen grid grid-cols-1 md:grid-cols-2 relative overflow-hidden pt-[72px] md:pt-0">
      {/* Left */}
      <div className="flex flex-col justify-between px-6 sm:px-10 md:px-[60px] py-12 md:py-[100px] border-b md:border-b-0 md:border-r border-border">
        <div>
          <p className="font-mono text-[10px] sm:text-[11px] text-accent tracking-[0.2em] uppercase">
      ...
      {/* Right */}
      <div className="flex flex-col justify-end px-6 sm:px-10 md:px-[60px] py-12 md:py-[100px] relative">
        {/* Ghost text — hide on smallest screens */}
        <div
